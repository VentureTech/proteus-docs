...
* [Martin Fowler on Software Design] (http://martinfowler.com/design.html) Like other good software architects, Martin Fowler is skilled in discerning and explaining the costs and benefits of design patterns.
...
Add exception handling to your program for the following cases:
    1. User enters a token that is neither a number nor an operator
